...
class List_Term_Object(object):
      ...
      def __init__(self,line,raw_mode,SEPERATE_CHAR,mongoObj,is_bigram_used=False):
          self.str=line.strip()
      ...
      def get_term(self,raw_mode,SEPERATE_CHAR):
          ...
          # list(set()) will break word order on Windows
          #self.term=list(set(qts))  
          self.term=qts          
      ...
      def update_bigram(self):
          self.bigrams=set(ngrams(self.term,2))
